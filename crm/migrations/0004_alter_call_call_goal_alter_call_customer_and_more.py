# Generated by Django 5.1.11 on 2025-07-21 05:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_of_company', models.CharField(default='Без названия', max_length=255, verbose_name='Название компании')),
                ('revenue_for_last_year', models.DecimalField(blank=True, decimal_places=2, help_text='Миллиард рублей', max_digits=12, null=True, verbose_name='Выручка за последний год')),
                ('length_of_electrical_network_km', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Длина сетей, км')),
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='branches', to='crm.customer', verbose_name='Родительский заказчик')),
            ],
            options={
                'verbose_name': 'Филиал',
